...
import './notifications.css'; // This should reference a CSS file in the same directory
          ...
          <div className="settings-content">
            <div className="settings-sidebar">
              ...
              <div className="nav-tabs-horizontal">
                ...
                <div className="nav-tab active" onClick={() => handleTabClick('/settings/notifications')}>
                  <Bell size={16} />
